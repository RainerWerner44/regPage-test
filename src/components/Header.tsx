...
const Header = () => {
  ...
  return (
    <header>
      ...
      <p className="font-inter text-[12px] font-normal leading-[18px] tracking-[-0.01em] text-left text-mainText">
        Step {registrationStep} of 4
      </p>

      <div className="w-full h-2 bg-white rounded border border-[#C9D3E0] mt-2">
        <div
          className={`h-full w-${registrationStep}/4 bg-[#C9D3E0] rounded`}
        ></div>
      </div>
